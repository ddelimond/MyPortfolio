...
const Projects = () => {
    return (
        <div class="">
            <section id='projects' class="max-w-[1240px] mx-auto px-2 py-16">
                <span class="uppercase dark:text-[rgb(14,178,243)] text-[rgb(16,129,212)] tracking-widest text-xl font-thin">Projects</span>
                <h2 class="font-bold py-4 dark:text-[rgb(14,178,243)]">What I've Built</h2>
