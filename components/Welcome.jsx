      ...
      <section className=' max-w-[1240px] w-full h-full mx-auto p-2  flex justify-center items-center'>
        <article>
          ...
          <article className='social flex  max-w-[330px] m-auto items-center justify-center gap-x-5 mx-auto my-4 w-full sm:w-[80%]'>
            ...
            <Link target='_blank' href="Darren_Delimond_2023.docx" className='text-[rgb(16,129,212)] dark:text-[rgb(14,178,243)] transition duration-500 hover:scale-[1.2] rounded-full shadow-lg shadow-gray-400 p-6' download="Darren Delimond's Resume"><FaFileDownload size={25} /></Link>
