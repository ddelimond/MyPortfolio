        ...
        <div className='w-full'>
            ...
            <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
                <div className='col-span-4'>
                    ...
                    <h2>Overview</h2>
                    <p>
                        This is a Online Ecommerce site that allows users to browse products, register, login, and checkout, users can also filter products by size and color.
                        When checking out use the test card number 4242 4242 4242 4242, a random three-digit CVC number, and any expiration date in the future. Complete the checkout process as normal.
                    </p>
